...
SWIGINTERN int Swig_var_ifdh__debug_set(PyObject *_val) {
  {
    int val;
...
SWIGINTERN PyObject *Swig_var_ifdh__debug_get(void) {
  PyObject *pyobj = 0;
...
SWIGINTERN PyObject *_wrap_ifdh__debug_get(PyObject *SWIGUNUSEDPARM(self), PyObject *SWIGUNUSEDPARM(args)) {
  return Swig_var_ifdh__debug_get();
}
...
SWIGINTERN PyObject *_wrap_ifdh__debug_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res = Swig_var_ifdh__debug_set(value);
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'new_ifdh'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    ifdh_ns::ifdh(std::string)\n"
    "    ifdh_ns::ifdh()\n");
  return NULL;
}
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'ifdh_dumpStation'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    dumpStation(ifdh_ns::ifdh *,std::string,std::string)\n"
    "    dumpStation(ifdh_ns::ifdh *,std::string)\n");
  return NULL;
}
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'ifdh_establishProcess'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    establishProcess(ifdh_ns::ifdh *,std::string,std::string,std::string,std::string,std::string,std::string,std::string,int)\n"
    "    establishProcess(ifdh_ns::ifdh *,std::string,std::string,std::string,std::string,std::string,std::string,std::string)\n"
    "    establishProcess(ifdh_ns::ifdh *,std::string,std::string,std::string,std::string,std::string,std::string)\n"
    "    establishProcess(ifdh_ns::ifdh *,std::string,std::string,std::string,std::string,std::string)\n");
  return NULL;
}
...
SWIG_init(void) {
  ...
  SWIG_addvarlink(SWIG_globals(),(char*)"ifdh__debug",Swig_var_ifdh__debug_get, Swig_var_ifdh__debug_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
